        ...
        <div class="banner-bg-agileits">
            ...
            <div class="banner-text">
                <div class="container">
                    ...
                    <h2 class="title">
                      Votre score est: <%=request.getAttribute("total")   %>
                      
                    	<%   if ( (Integer) session.getAttribute("passage") == 1)
                    		  {
                    			  session.setAttribute("passage", 0);
                    			  out.print(" Félicitation vous débloquez le niveau suivant");
                    		  }
                      
                    	%>	
                   
                    </h2>
                    <h2 class="title">      <a href="niveau.jsp" class="button">Suivant</a>   </h2>
                </div>
            </div>
            <!-- //banner-text -->
        </div>
